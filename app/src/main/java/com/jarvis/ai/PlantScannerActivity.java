...
public class PlantScannerActivity extends AppCompatActivity {
    ...
    public  static final String EXTRA_RESULT = "plant_result";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvTitle.setText("🌿  HENRY PLANT SCANNER");
        ...
        btnScan.setText("🔬  IDENTIFY PLANT");
    ...
    private void doCamera() {
        ...
        try {
            ...
            File file = File.createTempFile("PLANT_" + stamp, ".jpg", dir);
    ...
    protected void onActivityResult(int req, int res, Intent data) {
        ...
        try {
            ...
            if (pickedBitmap != null) {
                ...
                layoutResult.setVisibility(View.GONE);
                btnSendChat.setVisibility(View.GONE);
                tvHint.setText("Photo loaded. Tap IDENTIFY PLANT to scan.");
            }
        } catch (Exception e) {
    ...
    private void doScan() {
        ...
        new Thread(() -> {
            try {
                ...
                msg.put("role", "user");
                msg.put("text", "What plant is in this photo? Provide: "
                ...
                body.put("overrideSystem", "You are an expert zoologist and wildlife biologist. When shown an plant photo, identify it in detail. Describe: common name, scientific name, habitat, diet, conservation status, size, and 3 fun facts. Write like a nature documentary narrator. Never talk about anything other than the plant in the photo.");
                ...
                String reply = json.optString("reply",
                        "Could not identify this plant. Please try a clearer photo, sir.");
